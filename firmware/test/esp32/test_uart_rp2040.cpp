/**
 * @file test_uart_rp2040.cpp
 * @brief ESP32 <-> RP2040 UART Communication Test
 *
 * Tests bidirectional UART communication with the RP2040.
...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("\n========================================");
    Serial.println("ESP32 <-> RP2040 UART Test");
    Serial.println("========================================\n");

    // Initialize UART1 for RP2040 communication
