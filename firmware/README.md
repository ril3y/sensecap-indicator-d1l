...
**Interrupt Output (INT):** The TCA9535 has an open-drain INT pin connected to **ESP32 GPIO42**. This pin goes LOW when any input (IO2, IO3) changes state. Reading the Input Port register clears the interrupt. This enables interrupt-driven LoRa packet detection instead of polling.

See [docs/TCA9535_INTERRUPT_OPTIMIZATION.md](docs/TCA9535_INTERRUPT_OPTIMIZATION.md) for implementation details.
